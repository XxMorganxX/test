...
class Inventory():
    def __init__(self):
        ...
        self.level = 0
        self.fortune = 0
        self.item_id_capacity = {0: {1: 1000, 2: 1000, 3:500, 4:500, 5:250, 6:150, 7:150, 8:5}, 1: {1: 2000, 2: 2000, 3:1000, 4:1000, 5:500, 6:300, 7:300, 8:10}, 2: {1: 4000, 2: 4000, 3:2000, 4:2000, 5:1000, 6:600, 7:600, 8:20}}
        self.item_id_block_award_quantity = {1: 20, 2: 20, 3:10, 4:5, 5:3, 6:2, 7:2, 8:1}
    ...
    def create_text_popup(self, window, font, block, amount, mouse_pos):
        popup = font.render(f"Collected {amount}: {Item_Bundle.id_names[block]}", True, env.BLACK)
...
class Item_Bundle():
    id_names = {1:"Grass", 2:"Dirt", 3:"Stone", 4:"Metal", 5:"Diamond", 6:"Garnet", 7:"Topaz", 8:"Alzo"}
